...
export default function VendorDashboard({
  ...
  const [spaceList, setSpaceList] = useState([
    { name: 'Villa Natureza', location: 'São Paulo, SP', price: 8500 },
    { name: 'Espaço Serra', location: 'Mairiporã, SP', price: 7500 }
  ]);
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] font-sans antialiased text-[#2B2A27]">
      ...
      {/* Top Header */}
      <header className="sticky top-0 z-50 bg-white border-b border-[#EAE3D2] px-6 py-3 shadow-sm flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="flex items-center cursor-pointer relative h-12">
            <img src={logoGold} alt="Logo" className="w-12 h-12 object-contain" />
            <div className="flex flex-col text-left pl-3">
              <span className="font-serif text-sm tracking-wider font-bold uppercase text-[#2B2A27] leading-tight">
                MOMENTOS INESQUECÍVEIS
              </span>
              <span className="text-[8px] uppercase tracking-[0.2em] text-[#B8975A] font-bold leading-none">
        ...
        <div className="flex items-center space-x-6">
          <button className="relative p-2 text-[#6E6B64] hover:text-[#B8975A] transition-colors focus:outline-none cursor-pointer">
          ...
          <div className="relative">
            ...
            >
              <img
                src={userAvatar}
                alt="Profile Avatar"
                className="w-9 h-9 rounded-full object-cover border border-[#B8975A]/40 shadow-inner"
              />
      ...
      <div className="flex">
        {/* Left Sidebar */}
        <aside className="w-64 bg-white border-r border-[#EAE3D2] min-h-[calc(100vh-73px)] p-4 space-y-6 hidden md:flex flex-col justify-between">
        ...
        {/* Content Area */}
        <main className="flex-grow p-6 space-y-6 max-w-[1400px] mx-auto">
          {/* Welcome Banner */}
          <div className="bg-white border border-[#EAE3D2] rounded-3xl p-6 relative overflow-hidden shadow-sm flex flex-col md:flex-row items-center md:justify-between text-left gap-6 md:gap-0">
            ...
            <div className="relative z-10 space-y-3 max-w-xl">
              ...
              <h1 className="font-serif text-2xl md:text-3xl text-[#2B2A27] font-normal leading-snug">
                ...
                <span className="text-[#B8975A] italic font-serif">momentos inesquecíveis</span>
              </h1>
              ...
              return (
                <div key={stat.label} className="bg-white border border-[#EAE3D2] rounded-2xl p-5 shadow-sm space-y-4 text-left">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] uppercase tracking-wider text-[#6E6B64] font-semibold">
                      {stat.label}
                    </span>
                    <div className="w-8 h-8 rounded-full bg-[#FAF8F5] border border-[#EAE3D2]/40 flex items-center justify-center text-[#B8975A]">
                      <StatIcon className="w-4 h-4" />
                    </div>
                  </div>

                  <div className="space-y-1">
                    <p className="text-2xl font-bold font-serif text-[#2B2A27]">{stat.value}</p>
                    {stat.type === 'rating' ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-7 bg-white border border-[#EAE3D2] rounded-3xl p-5 shadow-sm text-left flex flex-col min-h-[500px]">
